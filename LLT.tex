...
\begin{document}
	...
	{\bodyfont  % Switch to body font for content
		...
		Let us now finalize an algorithm that uses use thin-airfoil theory as the source of our local lift coefficients, and let us set $c_d = 0$, which amounts to an assumption of high Reynolds number and attached flow.  Using our dimensionless variables, our LLT algorithm is then be summarized as follows.
