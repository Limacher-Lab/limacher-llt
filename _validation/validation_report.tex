...
\begin{document}
	...
	{\bodyfont  % Switch to body font for content
		...
		derived from the relation $C_L = a_0(\alpha - \alpha_i)$
		(Anderson, Eq.~(5.67)) and the induced angle of attack for an
		elliptic wing, $\alpha_i = C_L / (\pi AR)$
		(Anderson, Eq.~(5.42))~\citep[pp.~467--468]{Anderson2011}.
