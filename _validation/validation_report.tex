...
\begin{document}
	...
	{\bodyfont  % Switch to body font for content
		...
		\textit{Fundamentals of Aerodynamics}~\citep[Chapter~5]{Anderson2011}.
		...
		$\delta = 0$ for an elliptic planform~\citep[pp.~464--465]{Anderson2011}.
		...
		against classical theory~\citep{Anderson2011} for an elliptic wing.
		The key results are:
