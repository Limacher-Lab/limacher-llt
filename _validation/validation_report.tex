...
\begin{document}
	...
	{\bodyfont  % Switch to body font for content
		...
		\begin{equation}
			...
			\label{eq:liftslope}
		\end{equation}
		where $a_0 = 2\pi$ is the thin-airfoil sectional lift slope when sections are assumed to behave according to thin-airfoil theory.
		...
		spanwise stations, trapezoidal integration), as shown by the decreasing error with increasing $N$ in the convergence study described below.
